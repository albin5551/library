...
@Component({
  selector: 'app-book-view-test',
  templateUrl: './book-view-test.component.html',
  styleUrls: ['./book-view-test.component.css']
})
export class BookViewTestComponent implements OnInit {
