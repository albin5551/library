 ...
 */
package  librarymanagement.library.configuration;

import  librarymanagement.library.security.AccessTokenProcessingFilter;
import  librarymanagement.library.security.AccessTokenUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(POST,"/email/emailsentotp").anonymous()
                .antMatchers(POST,"/verify").anonymous()
